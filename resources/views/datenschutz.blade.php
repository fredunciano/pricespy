...
@section('content')
    <div class="row">
        ...
        <div class="col-md-10">
            <b class="text-orange">Haftung für Inhalte</b>
            <p>
                ...
                Informationen
                nach den allgemeinen Gesetzen bleiben hiervon unberührt. Eine diesbezügliche Haftung ist jedoch erst ab
                dem
        ...
        <div class="col-md-10">
            <b class="text-orange">Haftung für Links</b>
            <p>
        ...
        <div class="col-md-10">
            <b class="text-orange">Urheberrecht</b>
            <p>
