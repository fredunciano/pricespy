    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="first_name" name="first_name" class="form-control" placeholder="John"
                                   minlength="2" maxlength="100" value="{{ old('first_name', $userData->first_name) }}" disabled>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="last_name" name="last_name" class="form-control" placeholder="Doe"
                                   minlength="2" maxlength="100" value="{{ old('last_name', $userData->last_name) }}" disabled>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-12" style="border-right: 1px solid; border-right-color: #414860">
                        ...
                        <div class="col-md-12 col-xs-4 authorization-div" style="padding-left: 0;">
                            ...
                            <input type="checkbox" id="delete_competitor"
                                   ...
                                   @if(old('delete_competitor', $userData->permissions->delete_competitor)) checked @endif
                                   class="form-group" disabled
                                   data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                   data-on="@t('yes')" data-off="@t('no')"
                            >
                    ...
                    <div class="col-md-4 col-xs-12">
                        ...
                        <div class="col-md-12 col-xs-4 " style="padding-left: 0;">
                            ...
                            <input type="checkbox" id="view_invoice_and_payment_system"
                                   ...
                                   @if(old('view_invoice_and_payment_system', $userData->permissions->view_invoice_and_payment_system)) checked @endif
                                   class="form-group" disabled
                                   data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                   data-on="@t('yes')" data-off="@t('no')"
                            >
