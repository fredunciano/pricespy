...
<div id="sidebar-alt" tabindex="-1" aria-hidden="true">
    ...
    <a href="javascript:void(0)" id="sidebar-alt-close" onclick="Template.sidebar('toggle-sidebar-alt');"><i class="fa fa-times"></i></a>
    ...
    <div id="sidebar-scroll-alt">
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-section">
                ...
                <form action="/" method="post" class="form-control-borderless" onsubmit="return false;">
                    ...
                    <div class="form-group remove-margin">
                        <button type="submit" class="btn btn-effect-ripple btn-primary" onclick="Template.sidebar('close-sidebar-alt');">Save</button>
                    </div>
                </form>
            </div>
            <!-- END Profile -->
            ...
            <div class="sidebar-section">
                ...
                <form action="/" method="post" class="form-horizontal form-control-borderless" onsubmit="return false;">
                    <div class="form-group">
