...
<div id="page-wrapper"<?php if ($template['page_preloader']) { echo ' class="page-loading"'; } ?>>
    ...
    <div id="page-container"<?php if ($page_classes) { echo ' class="' . $page_classes . '"'; } ?>>
        @if ($template['inc_sidebar_alt'])
            @include('layouts.inc.' . $template['inc_sidebar_alt']);
        @endif
        @if ($template['inc_sidebar']) {
            @include('layouts.inc.' . $template['inc_sidebar']);
        @endif

        <!-- Main Container -->
        <div id="main-container">
            @if ($template['inc_header'])
                @include('layouts.inc.' . $template['inc_header']);
            @endif
