        ...
        <div class="col-md-8 col-md-offset-2">
            <form action="{{ route('pages.store') }}" method="post" class="">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="source_id">
                        @foreach ($sources as $source)
                            <option value="{{ $source->id }}" @if ($source->id == $sourceId) selected @endif>{{ $source->name }} ({{ $source->url }})</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="url" name="url" class="form-control" placeholder="Url" minlength="3" maxlength="100" value="{{ old('url') }}">
                    @if ($errors->has('url'))
