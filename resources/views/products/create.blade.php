...
@section('styles')
    <style>
        ...
        #mobile-image-picker #file-picker {
...
@section('content')
    <div class="row">
        ...
        <form id="product-form" action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-4 col-xs-12 pull-right" id="image-picker">

                <div class="col-md-12">

                    <label class="file-upload-area" id="file-picker" for="fileImage">
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="@t('name')"
                           maxlength="1000" value="{{ old('name') }}" required>
                    @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="link" name="link" class="form-control" placeholder="@t('link')"
                           maxlength="1000" value="{{ old('link') }}">
                    @if ($errors->has('link'))
                ...
                <div class="form-group">
                    ...
                    @php $sourceId = old('source_id') @endphp
                    <select id="source" name="source_id" class="form-control">
                        @foreach ($stores as $store)
                            <option data-vat="{{ $store->getVatAmplifier() }}" value="{{ $store->id }}"
                                    @if ($store->id == $sourceId) selected @endif>{{ $store->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    @php $categoryId = old('category_id'); @endphp
                    <select id="categories" class="form-control" name="category_id" required>
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}"
                                    @if ($category->id == $categoryId) selected @endif>{{ $category->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="vat_price" name="vat_price" class="form-control"
                           placeholder="{{ 10+$store->getVatAmplifier() }}" min="0" max="999999999" step="0.01"
                           value="{{ old('vat_price') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="price" name="price" class="form-control" placeholder="10.00" min="0"
                           max="9999999999" step="0.01" value="{{ old('price') }}" required>
                    @if ($errors->has('price'))
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="min_price" name="min_price" class="form-control"
                           placeholder="9.50" min="0" max="999999999" step="0.01"
                           value="{{ old('min_price') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="max_price" name="max_price" class="form-control"
                           placeholder="{{ 11.50 }}" min="0" max="999999999" step="0.01"
                           value="{{ old('max_price') }}">
                ...
                <div class="form-group">
                    <label for="shipping_cost">@t('shipping_cost') (&euro;)</label>
                    <input type="number" id="shipping_cost" name="shipping_cost" class="form-control"
                           placeholder="1" min="0" max="999999999" step="0.01"
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="purchase_price" name="purchase_price" class="form-control"
                           placeholder="9" min="0" max="999999999" step="0.01"
